...
export default function LeftColumn({ ingredients, tools }) {
  ...
  const [view, setView] = useState(hasIngredients ? 'ingredients' : 'tools')
  const [people, setPeople] = useState(1)

  useEffect(() => {
    setView(hasIngredients ? 'ingredients' : 'tools')
  }, [hasIngredients, hasTools])
